...
import 'package:myfoods/Screens/Welcome/LoginScreen.dart';
import 'package:myfoods/Screens/Welcome/SignInScreen.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Positioned(
            bottom: 0,
            child: Image.asset("assets/images/Slide3-Bg.png")
            // SvgPicture.asset(
          ...
          Positioned(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text('UN SERVICE \nCLIENT DISPONIBLE POUR TOUS VOS',
                    style: TextStyle(
                    color: thirtyColor, 
                    fontSize: 26,
